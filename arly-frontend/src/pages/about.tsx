    ...
    <PageTransition>
      <div className="max-w-3xl mx-auto pt-12 pb-6 px-4">
        <div className="bg-white border border-gray-100 rounded-2xl shadow-xl p-8 sm:p-10">
          ...
          <div className="border-t border-gray-100 pt-6 mt-6">
            <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-3">Project Members</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 text-center">
                <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 font-bold text-sm flex items-center justify-center mx-auto mb-2">UR</div>
                <p className="text-sm font-bold text-gray-800">Ujwal Rana</p>
                <p className="text-xs text-gray-400 mt-0.5">6th Sem Software Engineering</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 text-center">
                <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 font-bold text-sm flex items-center justify-center mx-auto mb-2">ST</div>
                <p className="text-sm font-bold text-gray-800">Sushan Tamang</p>
                <p className="text-xs text-gray-400 mt-0.5">6th Sem Software Engineering</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 text-center">
                <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 font-bold text-sm flex items-center justify-center mx-auto mb-2">AT</div>
                <p className="text-sm font-bold text-gray-800">Anmol Tamang</p>
                <p className="text-xs text-gray-400 mt-0.5">6th Sem Software Engineering</p>
              </div>
            </div>
          </div>
