...
export default function UrlInputHub({ onUrlSubmit, isLoading }: UrlInputHubProps) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto text-center">
      <span
        className="inline-flex items-center gap-2 rounded-full bg-[#21365E]/5 px-3 py-1 text-xs font-semibold tracking-wide text-[#21365E] uppercase mb-5"
      ...
      <h1
        className="text-5xl sm:text-6xl font-black text-[#16181F] tracking-tight mb-3 leading-[1.05]"
        style={{ fontFamily: "'Fraunces', serif" }}
      >
        ARLY
      </h1>
      <p className="text-lg text-[#5B6270] font-medium mb-8 max-w-lg mx-auto">
      ...
      <form
        ...
        className="relative rounded-2xl shadow-[0_20px_50px_-20px_rgba(22,24,31,0.25)] bg-white p-2 border border-[#16181F]/10"
      >
        <div className="flex flex-col sm:flex-row gap-2">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              className={`block w-full rounded-xl border-0 py-4 pl-11 pr-4 text-[#16181F] placeholder:text-[#5B6270]/50 focus:ring-2 focus:ring-inset focus:ring-[#21365E] text-sm bg-[#FBFAF6] outline-none transition-all ${
